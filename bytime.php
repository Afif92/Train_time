...
<html lang="en-US">
  ...
  <body>
    <center>
	 ...
	 $sq2 = "SELECT time FROM time";
	 
	 $result3 = mysqli_query($con,$sq2);
	 $result4 = mysqli_query($con,$sq2);
	 	
		
		
        
	 ?> 
		 <form id="sform" name="sform1" method="post" action="trhistorytime.php">
		...
		<?php
				...
				?>
				 <br></br>
			 <br></br>
		     <th> <input type="submit" name="submit" id="submit" value="Submit" class="btn"/></th>
				<tr>
